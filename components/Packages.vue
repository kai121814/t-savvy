  ...
  <div class="BG w-full bg-[url('../assets/bg/BG2.png')] bg-no-repeat bg-cover cursor-default" id="packages">
    <div class="w-full justify-center">
      <div class="w-full flex mx-auto justify-center">
        <h1 class="my-10 text-7xl text-[#4AA3AA] px-3 font-black uppercase text-outline">Packages</h1>
      </div>
      <div class="w-full flex mx-auto justify-center items-stretch">

        <div class="w-1/4 h-80 p-7 bg-[#A7D5D8] m-4 rounded-3xl self-center text-center dropshadow animate-zoom cursor-pointer">
        ...
        <div class="w-1/4 h-96 p-7 bg-[#6DB3B8] m-4 rounded-3xl self-center text-center dropshadow animate-zoom cursor-pointer">
